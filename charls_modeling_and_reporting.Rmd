...
export_summs(
  ...
  error_pos = "same"
  ,to.file = "xlsx",
  file.name = "writing/july 2020/1-never-married.xlsx"
)
```
...
export_summs(
  ...
  error_pos = "same"
  ,to.file = "xlsx",
  file.name = "writing/july-2020/2-married-gift-home.xlsx"
)
``` 
...
export_summs(
  ...
  error_pos = "same"
  ,to.file = "xlsx",
  file.name = "writing/july-2020/3-married-ownership.xlsx"
)
```
