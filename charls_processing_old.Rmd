...
hukou_2014 <- hukou_2014 %>% mutate(id = id %>% as.character(),
                                    hukoutype = hukoutype %>% as.character(),
                                    hk004_1_ = hk004_1_ %>%as.character(),
                                    hk004_2_ = hk004_2_ %>%as.character(),
                                    hk004_3_ = hk004_3_ %>%as.character(),
                                    hk004_4_ = hk004_4_ %>%as.character(),
                                    hk004_5_ = hk004_5_ %>%as.character(),
                                    hk004_6_ = hk004_6_ %>%as.character())
hukou_2014$birthyear[is.na(hukou_2014$birthyear) == TRUE]<-1960
hukou_2014$hukoutype[is.na(hukou_2014$hukoutype) == TRUE]<-"1 Agricultural Hukou"
...
hukou_2014$hukou[hukou_2014$hukou %in% c("2 Non-agricultural Hukou", "3 Unified Residence Hukou", "4 None")] <-
  "1 urban hukou"
hukou_2014$hukou[hukou_2014$hukou == "1 Agricultural Hukou"] <- "0 rural hukou"
